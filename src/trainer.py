...
def train(train_loader, model, loss_func, metric_func, device, optimizer):
...
class ModelTrainer:
    def __init__(self, model, train_loader, valid_loader, loss_func, metric_func, optimizer,
                       device, save_dir, mode='max', scheduler=None, num_epochs=25, num_snapshops=None, parallel=False):
